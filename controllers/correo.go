...
import (
	...
	"github.com/udistrital/agenda_api_v2/models"
...
func (c *CorreoController) Post() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddCorreo(&v); err == nil {
			...
			c.Data["json"] = map[string]interface{}{"Success": true, "Status": "201", "Message": "Correo creado exitosamente", "Data": v}
		} else {
			logs.Error(err)
			c.Data["message"] = "Error service POST: The request contains an incorrect datatype or an invalid parameter"
			c.Abort("400")
		}
	} else {
		logs.Error(err)
...
func (c *CorreoController) GetOne() {
	...
	if err != nil {
		logs.Error(err)
		c.Data["message"] = "Error service GetOne: The request contains an incorrect datatype or an invalid parameter"
		c.Abort("400")
	} else {
...
func (c *CorreoController) GetAll() {
	...
	if err != nil {
		logs.Error(err)
		c.Data["message"] = "Error service GetAll: The request contains an incorrect datatype or an invalid parameter"
		c.Abort("400")
	} else {
...
func (c *CorreoController) Put() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		...
		if err := models.UpdateCorreoById(&v); err == nil {
			c.Data["json"] = map[string]interface{}{"Success": true, "Status": "200", "Message": "Correo actualizado exitosamente", "Data": v}
		} else {
			logs.Error(err)
			c.Data["message"] = "Error service PUT: The request contains an incorrect datatype or an invalid parameter"
			c.Abort("400")
		}
	} else {
		logs.Error(err)
...
func (c *CorreoController) Delete() {
	...
	if err := models.DeleteCorreo(id); err == nil {
		...
		c.Data["json"] = map[string]interface{}{"Success": true, "Status": "200", "Message": "Correo eliminado exitosamente", "Data": d}
	} else {
		logs.Error(err)
		c.Data["message"] = "Error service Delete: The request contains an incorrect datatype or an invalid parameter"
		c.Abort("400")
	}
	c.ServeJSON()
}
